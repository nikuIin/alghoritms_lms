...
const CommandsBar = ({ onCommandClick }) => { // Change onCommandDrop to onCommandClick
    ...
    useEffect(() => {
        const fetchCommands = async () => {
            ...
            try {
                const response = await axios.get(`http://127.0.0.1:8000/actions/${assignmentId}/`);
                ...
                const formattedCommands = actions.map(action => {
                    ...
                    return {
                        ...
                        y_changes: (name === "Step up" || name === "Step down") ? -yChanges : yChanges //Conditional
                    };
                });
